...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 146.0, 247.0, 22.0 ],
									"text" : "combine /System/Library/Sounds/ Basso .aiff"
								}
...
,
					"patching_rect" : [ 649.0, 280.0, 63.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 299.0, 185.0, 22.0 ],
					"text" : "/System/Library/Sounds/Funk.aiff"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.0, 262.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.0, 238.0, 85.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 237.0, 365.0, 50.0, 22.0 ],
					"text" : "88200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 304.0, 150.0, 22.0 ],
					"text" : "shelly.sr \"Built-in Output\" 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 74.0, 214.0, 107.0, 22.0 ],
					"text" : "ZoomAudioDevice"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 74.0, 299.0, 52.0, 22.0 ],
					"text" : "shelly.sr"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 245.0, 193.0, 234.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 245.0, 88.0, 145.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 245.0, 122.0, 172.0, 22.0 ],
					"text" : "shelly.notification"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 60.0, 62.0, 40.0, 40.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 122.0, 80.0, 22.0 ],
					"text" : "shelly.volume"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "shelly.volume.maxpat",
				"bootpath" : "~/Documents/Shelly",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
